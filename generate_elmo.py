...
fn = './data/conll/json/dev.english.json'
outfn = './data/conll/elmo/dev.english.hdf5'
Elmo(fn, outfn)
fn = './data/conll/json/train.english.json'
outfn = './data/conll/elmo/train.english.hdf5'
Elmo(fn, outfn)
fn = './data/conll/json/test.english.json'
outfn = './data/conll/elmo/test.english.hdf5'
Elmo(fn, outfn)
